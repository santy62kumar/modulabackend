...
// //       const hasSelectedService = Object.keys(services).some(key => {
// //         if (key === 'other') {
// //           return services[key] && services[key].trim().length > 0;
// //         }
...
// //       if (services.other && typeof services.other !== 'string') {
// //         throw new Error('Other service description must be a string');
// //       }

// //       if (services.other && services.other.length > 500) {
// //         throw new Error('Other service description must be less than 500 characters');
// //       }

// //       return true;
// //     }),

// //   // Individual service validations (optional boolean checks)
// //   body('services.fixDrawerAlignment').optional().isBoolean(),
// //   body('services.channelHingeServicing').optional().isBoolean(),
// //   body('services.replaceDamagedHardware').optional().isBoolean(),
// //   body('services.fixLooseHinges').optional().isBoolean(),
// //   body('services.kitchenDeepClean').optional().isBoolean(),
// //   body('services.addCoatingShutters').optional().isBoolean(),
// //   body('services.fixApplianceIssues').optional().isBoolean(),
// //   body('services.addKitchenAccessories').optional().isBoolean(),
// //   body('services.upgradeShutters').optional().isBoolean(),
// //   body('services.remodelKitchen').optional().isBoolean(),
// //   body('services.addMoreUnits').optional().isBoolean(),
// //   body('services.upgradeAppliances').optional().isBoolean(),
// //   body('services.repairMinorDamages').optional().isBoolean(),
// //   body('services.fixUnderCabinetLighting').optional().isBoolean(),
// //   body('services.changeHoodFilter').optional().isBoolean(),
// //   body('services.other').optional().isString().trim()
// // ];
