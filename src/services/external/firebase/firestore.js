...
// // server/src/services/external/firebase/firestore.js - Updated to use centralized Firebase

// import firebaseConfig, { db, arrayUnion, getServerTimestamp } from '../../../config/firebase.js';
// import { normalizePhone } from '../../utils/phoneUtils.js';

// /**
//  * Firestore Service - Database operations layer
...
//       // First get current document to check for duplicates
//       const projectDoc = await this.db
//         .collection('project_tracking')
//         .doc(projectId)
//         .get();
...
//         .doc(projectId)
//         .update({
//           stage_history: arrayUnion(stageData),
//           current_stage_id: stageData.stage_id,
//           current_custom_stage: stageData.custom_stage,
//           updated_at: getServerTimestamp()
//         });
...
// // Export the service instance and direct db access
// export default firestoreService;
// export { db };